...
export default function ChargeSuccessPage() {
  ...
  return (
    <div className="h-[100vh] w-full flex flex-col items-center justify-center bg-white text-primary animate-fade-in">
      <div className="animate-spin-slow mb-12">
        <Receipt className="w-20 h-20 text-primary" />
      </div>
      <div className="text-xl font-semibold text-gray-800">결제 처리 중입니다...</div>
