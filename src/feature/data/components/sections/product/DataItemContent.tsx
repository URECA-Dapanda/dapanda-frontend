...
export default function DataItemContent({
  ...
  return (
    <div className="grid grid-cols-[auto_1fr_auto] items-center justify-center gap-x-8 self-center mt-[-10]">
      ...
      <div className="flex flex-col items-end text-right self-start mt-[-20]">
